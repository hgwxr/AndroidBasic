...
public class HttpUtil {
    ...
    public static byte[] getDataByteArray(final String imgPath/*, final DealDataArray dealDataArray*/) {
        ...
        try {
           ...
           // dealDataArray.dealDataArray(stream.toByteArray());
        } catch (IOException e) {
